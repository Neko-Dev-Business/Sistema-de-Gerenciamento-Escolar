                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select name="tipoPessoa" id="tipoPessoa" class="form-select form-select-lg bg-light"
                                    ...
                                    <option value="">Selecione</option>
                                    <option value="F" {{ $pessoas->tipoPessoa == 'F' ? 'selected' : '' }}>Física
                                    </option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" id="user_type" name="user_type" required>
                                    <option value="A" {{ $pessoas->tipoUsuario == 'A' ? 'selected' : '' }}>Aluno
                                    </option>
                                    <option value="P" {{ $pessoas->tipoUsuario == 'P' ? 'selected' : '' }}>Professor
                                    </option>
                                    <option value="R" {{ $pessoas->tipoUsuario == 'R' ? 'selected' : '' }}>
                                        Responsável
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="TEXT" class="form-control" id="password" name="password"
                                    value="{{ $pessoas->password }}" required>
                            </div>
                        </div>
                    </div>
                </div>
