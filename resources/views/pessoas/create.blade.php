                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="div-cpfPessoa">
                                ...
                                <input type="text" class="form-control" id="cpfPessoa" name="cpfPessoa"
                                    placeholder="Apenas Números" pattern="\d*" maxlength="14" minlength="11">
                            </div>
                            ...
                            <div class="form-group" id="div-cnpjPessoa">
                                ...
                                <input type="text" class="form-control" id="cnpjPessoa" name="cnpjPessoa"
                                    placeholder="Apenas Números" maxlength="20" minlength="14"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" placeholder="(99) 9999-9999" maxlength="18"
                                    ...
                                    class="form-control form-control-lg bg-light" id="telefonePessoa"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                        onclick="generateRandomPassword()">Gerar Senha Aleatória</button>
                                </div>
                            </div>
                        </div>
                    </div>
