    ...
    <div class="container">
        ...
        <form class="row g-4" method="POST" action="{{ route('alunos.store') }}">
            ...
            <div class="col-md-4">
                ...
                <input type="date" class="form-control form-control-lg bg-light" id="dtMatriculaAluno"
                    name="dtMatriculaAluno" required>
            </div>
            <div class="col-md-4">
                <label for="dtDesligamentoAluno" class="form-label fs-5">Data de Desligamento</label>
                <input type="date" class="form-control form-control-lg bg-light" id="dtDesligamentoAluno"
                    name="dtDesligamentoAluno">
            </div>
            <div class="mt-5">
