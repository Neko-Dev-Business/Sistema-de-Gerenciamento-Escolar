                ...
                @if ($escola)
                    <form action="{{ route('escola.update', $escola->id) }}" method="POST">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" id="nomeEscola" name="nomeEscola"
                                value="{{ $escola->nomeEscola }}" required>
                        </div>
                        <div class="mb-2">
                            <label for="secretariaEscola" class="form-label">Secretário(a):</label>
                            <input type="text" class="form-control" id="secretariaEscola" name="secretariaEscola"
                                value="{{ $escola->secretariaEscola }}" required>
                        </div>
                        <div class="mb-2">
                            <label for="diretoraEscola" class="form-label">Diretor(a):</label>
                            <input type="text" class="form-control" id="diretoraEscola" name="diretoraEscola"
                                value="{{ $escola->diretoraEscola }}" required>
                        </div>
                        <div class="mb-2">
                            <label for="enderecoEscola" class="form-label">Endereço:</label>
                            <input type="text" class="form-control" id="enderecoEscola" name="enderecoEscola"
                                value="{{ $escola->enderecoEscola }}" required>
                        </div>
                        <div class="mb-2">
                            <label for="telefoneEscola" class="form-label">Telefone:</label>
                            <input type="text" class="form-control" id="telefoneEscola"name="telefoneEscola"
                            value="{{ $escola->telefoneEscola }}" required>
                        </div>
                        <div class="mb-2">
                            <label for="emailEscola" class="form-label">Email:</label>
                            <input type="text" class="form-control" id="emailEscola"name="emailEscola"
                            value="{{ $escola->emailEscola }}" required>
                        </div>
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" id="assinaturaDiretoraEscola"
                                name="assinaturaDiretoraEscola" value="{{ $escola->assinaturaDiretoraEscola }}" required>
                        </div>
                        <div class="mb-2">
                            <label for="cnpjEscola" class="form-label">CNPJ:</label>
                            <input type="text" class="form-control" id="cnpjEscola" name="cnpjEscola"
                                value="{{ $escola->cnpjEscola }}" required>
                        </div>
